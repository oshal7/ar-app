...
/** Draws the live ARCore camera image as a full-screen background quad. */
class BackgroundRenderer {
    ...
    fun createOnGlThread() {
        ...
        quadCoords = ByteBuffer.allocateDirect(ndc.size * 4)
            .order(ByteOrder.nativeOrder()).asFloatBuffer()
        quadCoords.put(ndc).position(0)

        quadTexCoords = ByteBuffer.allocateDirect(ndc.size * 4)
            .order(ByteOrder.nativeOrder()).asFloatBuffer()
        // filled per-frame by ARCore
